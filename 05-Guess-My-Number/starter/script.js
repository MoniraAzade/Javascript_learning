...
document.querySelector('.again').addEventListener('click', function () {
  //here click is called an event& this function()is called anonymous handler function.
  score = 20;
  secretNumber = Math.trunc(Math.random() * 20 + 1); //create a new secretNumber & reassign the variable.
